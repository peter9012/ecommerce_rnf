...
CREATE PROCEDURE  Migration.Migration_Hybris_OrderHeader_QA @LastRun DATETIME = '05/01/2014'AsBEGIN 
SET NOCOUNT ON
...
CREATE CLUSTERED INDEX MIX_RFLoad ON #LoadedOrders (code);
...
CREATE CLUSTERED INDEX MIX_HYOrder ON #Hybris_Orders (code)
