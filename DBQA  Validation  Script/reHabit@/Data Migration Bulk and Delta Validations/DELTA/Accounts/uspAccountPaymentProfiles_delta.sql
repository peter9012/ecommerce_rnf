...
EXECUTE dbqa.uspPrintMessage @message
	...
	pp.PaymentProfileID ,--PaymentProfileID_Code
            ab.AccountNumber AS [p_customerid] ,
...
*/
	...
	SET @message=' STEP:2 Target Table Loadidng.'
	EXECUTE dbqa.uspPrintMessage @message
...
SELECT  a.RFOKey ,
        ...
        CASE WHEN a.RFOkey IS NULL THEN 'MissingInRFO-LoadedExtraInHybris'
             WHEN b.HybrisKey IS NULL THEN 'MissingInHybris-NotLoadedInHybris'
        END AS [Missing From ]
INTO    #Missing
FROM    #RFO a
...
SELECT  a.RFOKey ,
        b.[HybrisKey] ,
        CASE WHEN a.RFC > b.HBC THEN 'paymentInfos Not Loaded in hybris'
             WHEN a.RFC < b.HBC THEN 'paymentInfos Extra Loaded in hybris'
        END AS MixMatch
INTO    #MixMatch
FROM    ( SELECT    RFOKey ,
                    COUNT(*) AS [RFC]
