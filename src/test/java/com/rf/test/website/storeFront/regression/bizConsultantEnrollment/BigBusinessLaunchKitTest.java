...
public class BigBusinessLaunchKitTest extends RFWebsiteBaseTest{
	private static final Logger logger = LogManager
			.getLogger(BigBusinessLaunchKitTest.class.getName());
	...
	public void testStandardEnrollmentBigBusinessKitRedefineRegimen_73() throws InterruptedException{
		...
		storeFrontHomePage.selectEnrollmentKitPage(TestConstants.KIT_PRICE_BIG_BUSINESS, TestConstants.REGIMEN_NAME_REDEFINE);		
