...
public class PersonalResultsKitTest extends RFWebsiteBaseTest{
	...
	// Hybris Project-48 :: Version : 1 :: Standard EnrollmentTest USD 395 Personal Results Kit, Personal Regimen REDEFINE REGIMEN  
	@Test
	...
	public void testStandardEnrollmentPersonalRegimenKitUnblemishRegimen_49() throws InterruptedException{
		...
		storeFrontHomePage.searchCID();
		storeFrontHomePage.mouseHoverSponsorDataAndClickContinue();
		storeFrontHomePage.enterUserInformationForEnrollment(kitName, regimenName, enrollmentType, TestConstants.FIRST_NAME+randomNum, TestConstants.LAST_NAME, password, addressLine1, city, postalCode, phoneNumber);
		storeFrontHomePage.clickEnrollmentNextBtn();
		storeFrontHomePage.acceptTheVerifyYourShippingAddressPop();		
		storeFrontHomePage.enterCardNumber(TestConstants.CARD_NUMBER);
		storeFrontHomePage.enterNameOnCard(TestConstants.FIRST_NAME+randomNum);
