...
CREATE PROCEDURE [dbqa].[uspRFO_Comm_OrderReturnItem_Delta] (@StartDate DATE,@EndDate DATETIME=NULL)
AS
    BEGIN
...
SET @EndDate=ISNULL(@EndDate,GETDATE()-1)
        ...
        DECLARE @SourceCount INT ,
            ...
            @owner NVARCHAR(50)= 'Comm_OrderReturnItems' ,
        ...
        SELECT  ri.ReturnOrderID AS [SourceKey] ,
                re.OrderID AS r_OrderID ,
                ri.OrderItemID AS r_OrderItemID ,
                ri.ReceivedQuantity AS r_Quantity ,
                ri.ReturnItemID AS r_ReturnItemID ,
                ri.RefundedDate AS r_CreatedOn ,
                ri.DateModified AS r_UpdatedOn ,
                ri.ReturnReasonID AS r_ReturnReasonID ,
                ri.ReturnStatusID AS r_ReturnStatusID
        INTO    #Source
        FROM    RFOperations.Hybris.ReturnItem ri
                JOIN RFOperations.Hybris.ReturnOrder re ON re.ReturnOrderID = ri.ReturnOrderID              
        WHERE   ri.ServerModifiedDate BETWEEN @StartDate
                                      AND     @EndDate 
...
SELECT [OrderID]
      ...
      ,[ReturnReasonID]
	  INTO #Target
  FROM [Commissions].[etl].[OrderReturnItems]
...
--++++++++++++++++++--++++++++++++++++++
        ...
        INSERT  INTO @DUP
                ...
                FROM    #Source
                GROUP BY SourceKey,r_OrderItemID
        ...
        INSERT  INTO @DUP
                ...
                FROM    #Target
                GROUP BY TargetKey,ReturnItemID
...
--++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      FROM    DM_QA.dbqa.Map_tab
        WHERE   [Owner] = 'rfo_comm_orderreturnitems'
