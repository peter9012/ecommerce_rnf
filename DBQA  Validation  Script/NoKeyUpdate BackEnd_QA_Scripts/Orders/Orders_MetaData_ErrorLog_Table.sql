...
,( 0,'Addresses_Billing','OrderBillingAddressID','OrderBillingAddressID','PK')
...
,( 0,'OrderNotes','OrderNoteID','OrderID','p_order')
...
,( 0,'PaymentInfos','OrderPaymentID ','OrderPaymentID','PK')
...
,( 0,'PaymentInfos','OrderPaymentID ','CardNumber','p_number')
,( 0,'PaymentInfos','OrderPaymentID ','Expmonth','p_validtomonth')
,( 0,'PaymentInfos','OrderPaymentID ','ExpYear','p_validtoyear')
,( 0,'PaymentInfos','OrderPaymentID ','ccowner','ccowner')
...
,( 0,'paymnttrnsctentries','OrderPaymentTransactionID','TransactionID','p_subscriptionid')
