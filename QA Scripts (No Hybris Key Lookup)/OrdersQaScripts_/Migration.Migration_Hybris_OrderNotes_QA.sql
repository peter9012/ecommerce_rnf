...
,CAST( ISNULL(p_ordernotes,'') AS NVARCHAR (max)) AS  p_ordernotes
--,CAST( p_uid AS NVARCHAR (100)) AS  p_uid
,CAST( LTRIM(RTRIM(p_subject)) AS NVARCHAR (max)) AS  p_subject
