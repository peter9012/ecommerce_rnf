...
CAST(DATEADD(HH,8,StartDate) AS DATE) as StartDate__c,
CAST(DATEADD(HH,8,EndDate) AS DATE) as EndDate__c,
CAST(DATEADD(HH,8,s.ServerModifiedDate) AS DATE) as ServerModifiedDate__c,
...
CAST(DATEADD(HH,8,Expirationdate) AS DATE) as Expirationdate__c,
PrimaryDomain__C,
BusinessDomain__c,
