...
CREATE PROCEDURE [dbqa].[uspHybris_Comm_OrderReturns_Delta]
    (
      @StartDate DATE ,
...
--+++++++++++++++++++++++++++++++++++++++++
        ...
        DECLARE @SourceCount INT ,
            ...
            @owner NVARCHAR(50)= 'Comm_OrderReturns' ,
            @Key NVARCHAR(25)= 'OrderReturnID' ,
        ...
        SELECT  ro.ReturnOrderID AS [SourceKey] ,
                ro.OrderID AS r_OrderID ,
                ro.CompletionDate AS r_TransactionDate ,
                ro.CommissionDate AS r_ReturnCommissionDate ,
                201702 AS r_PeriodID ,
                ro.CompletionDate AS r_CreatedOn ,
                ro.ModifiedDate AS r_UpdatedOn ,
                ro.ServerModifiedDate AS r_ServerModifiedDate ,
                ro.ReturnStatusID AS r_ReturnStatusID ,
                rn.ReturnNoteID AS r_ReturnReasonID
        INTO    #Source
        ...
        WHERE   Owner = 'rfo_comm_orderreturns'
        ...
        SELECT  [OrderReturnID] AS [TargetKey] ,
                [TransactionNumber] ,
                [OrderID] ,
                [TransactionDate] ,
                ...
                [ReturnReasonID]
        INTO    #Target
        FROM    [Commissions].[etl].[OrderReturns]
