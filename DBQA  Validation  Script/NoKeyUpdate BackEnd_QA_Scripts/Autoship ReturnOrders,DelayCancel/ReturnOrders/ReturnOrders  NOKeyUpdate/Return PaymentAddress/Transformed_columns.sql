 ...
 SELECT 'Return PaymentAddress Loading TempTable ' AS EntityName ,
 ...
 SELECT @StartedTime AS StartedTime ,
        ...
        'Return PaymentAddress Temp Table Load Time ' AS Entity; 
		
		

 SELECT 'Return PaymentAddress Transformed Columns  Validation Started ' AS EntityName ,
        GETDATE() AS StartedTime;
 SELECT @StartedTime = CAST(GETDATE() AS TIME);
