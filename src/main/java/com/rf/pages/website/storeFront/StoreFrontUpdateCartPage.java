...
public class StoreFrontUpdateCartPage extends StoreFrontRFWebsiteBasePage{
	...
	public void clickOnBuyNowButton() throws InterruptedException{
		if(driver.getCountry().equalsIgnoreCase("CA")){
			...
			if(driver.findElement(By.xpath("//div[@id='main-content']/div[5]/div[1]//button[contains(text(),'ADD TO BAG')]")).isEnabled()==true)
				//driver.click(By.xpath("//div[@id='main-content']/div[5]/div[1]//button[contains(text(),'ADD TO BAG')]"));
				driver.clickByJS(RFWebsiteDriver.driver, driver.findElement(By.xpath("//div[@id='main-content']/div[5]/div[1]//button[contains(text(),'ADD TO BAG')]")));
			else
