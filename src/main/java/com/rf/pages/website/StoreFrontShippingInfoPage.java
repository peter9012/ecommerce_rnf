...
public class StoreFrontShippingInfoPage extends RFWebsiteBasePage{
	...
	private final By NEW_SHIPPING_PROFILE_SAVE_BTN_LOC = By.id("submitButton");
	...
	public void selectCardNumber(String cardNumber){
		Select cardNumberDD = new Select(driver.findElement(By.id("cardDropDowndropdown")));
		cardNumberDD.selectByVisibleText(cardNumber);
	}
