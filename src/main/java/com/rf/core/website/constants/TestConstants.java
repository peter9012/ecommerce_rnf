...
public class TestConstants {
	...
	public static final String SPONSOR = "tracy sharpe";
	//public static final String SPONSOR = "purush@consult2.com";
	public static final String SPONSOR_PREFIX = "tsharpe";
	public static final String SPONSOR_3_CHARS = "tes";
	public static final String SPONSOR_FIRST_NAME = "Tracy";
	public static final String SPONSOR_LAST_NAME = "Sharpe";
	public static final String SPONSOR_EMAIL = "tsharpe.test@rf.com";
	...
	public static final String PASSWORD_VALIDATION_ERROR_LESS_THAN_EIGHT_CHARS = "Please enter at least 8 characters";
