...
USE DM_QA
GO
CREATE PROCEDURE dbqa.uspOrderShippingAddress_delta
    (
      @StartDate DATE ,
...
AS
    BEGIN
        ...
        WHERE   EXISTS ( SELECT 1
                ...
                AND osa.ServerModifiedDate BETWEEN @StartDate
                                           AND     @EndDate
...
--++++++++++++++++++--++++++++++++++++++
        SET @message = CONCAT(' STEP: 5.initiating DUPLICATE Need to updaete Scripts and Need to delete from End to End Temps   ',
                              CHAR(10),
                              '-----------------------------------------------')
        EXECUTE dbqa.uspPrintMessage @message
