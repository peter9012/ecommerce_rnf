...
select distinct d.returnitemid, a.returnorderid, d.orderitemid, d.action, d.returnstatusid, d.returnreasonid, e.LineItemNo, f.pk, e.RetailProfit, e.WholesalePrice, e.TaxablePrice, a.totaltax
INTO #tempact 
from hybris.returnorder a,
hybris.dbo.orders b,
hybris.dbo.users c,
