...
--		StartedTime TIME,
--		CompletionTime TIME,
--		[Total Time (HH:mm:ss)] NVARCHAR(255),
--		RunDate DATE)
...
SELECT  @StartedTime AS StartedTime ,
        ...
        CONCAT(DATEDIFF(HOUR, @StartedTime, @EndTime), ':',
               DATEDIFF(MINUTE, @StartedTime, @EndTime), ':',
               DATEDIFF(SECOND, @StartedTime, @EndTime)) AS [Total Time (HH:mm:ss)] ,
