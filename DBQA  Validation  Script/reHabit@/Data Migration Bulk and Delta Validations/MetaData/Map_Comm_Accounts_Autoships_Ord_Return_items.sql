...
,-- CurrencyCode 
(N'RFOperations.Hybris.Orders' ,N'r_AccountID',N'int' ,N'' ,N'Commissions.etl.Orders' ,N'AccountID' ,N'int' ,N'OrderID' ,N'' , N'c2c' ,N'RFO_RFO_Comm_Orders',N'') 
,-- AccountID 
(N'RFOperations.Hybris.Orders' ,N'r_ConsultantID',N'int' ,N'' ,N'Commissions.etl.Orders' ,N'ConsultantID' ,N'int' ,N'OrderID' ,N'' , N'c2c' ,N'RFO_RFO_Comm_Orders',N'') 
,-- ConsultantID 
(N'RFOperations.Hybris.Orders' ,N'r_CompleteDate',N'Datetime' ,N'' ,N'Commissions.etl.Orders' ,N'CompleteDate' ,N'datetimeoffset' ,N'OrderID' ,N'' , N'c2c' ,N'RFO_RFO_Comm_Orders',N'') 
,-- CompleteDate
