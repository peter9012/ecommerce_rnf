USE DM_QA
GO
CREATE   PROCEDURE dbqa.uspOrderItem_delta
    (
      @StartDate DATE ,
...
--*******************************************************************************************************
        ...
        WHERE   EXISTS ( SELECT 1
                ...
                AND oi.ServerModifiedDate BETWEEN @StartDate
                                          AND     @EndDate
...
-- Only Orders loaded in Hybris.
        ...
        WHERE   oe.ModifiedTS BETWEEN @StartDate AND @EndDate
