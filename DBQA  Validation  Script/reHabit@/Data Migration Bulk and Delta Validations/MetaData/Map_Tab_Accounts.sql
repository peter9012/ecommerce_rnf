...
,--p_sessioncurrency
(N'RFOperations.Hybris.AccountBasee',N'LanguageID',N'Bigint',N'',N'Hybris.dbo.users',N'p_sessionlanguage',N'BIGINT',N'AccountNumber',N'Hybris.dbo.languages', N'def',N'Accounts',N'') 
,--p_sessionlanguage
...
,--p_token
(N' ',N'',N'',N'Hybris System Attribute',N'Hybris.dbo.users',N'Typepkstring',N'bigint',N'AccountNumber',N'PK from Hybris.dbo.composedtypes for Customers', N'default',N'Accounts',N'SELECT  u.p_customerid HybrisKey ,
        u.TypePkString ,
...
,--p_logindisabled
(N' ',N'',N'BIT',N'',N'Hybris.dbo.users',N'OwnerPkString',N'bigint',N'AccountNumber',N'', N'default',N'Accounts',N'') 
,--OwnerPkString
(N' ',N'',N'BIT',N'',N'Hybris.dbo.users',N'OwnerPkString',N'bigint',N'AccountNumber',N'', N'default',N'Accounts',N'') 
...
,--p_cctoken
 (N'',N'',N'',N'Hybris System Attributes',N'Hybris.dbo.Paymentinfos',N'p_original',N'bigint',N'AccountNumber',N'Null for AccountLevel PaymentInfos', N'default',N'AccountPaymentProfiles',N'') 
,--p_original
 (N'',N'',N'',N'Hybris System Attributes',N'Hybris.dbo.Paymentinfos',N'p_duplicate',N'bigint',N'AccountNumber',N'Null for AccountLevel PaymentInfos', N'default',N'AccountPaymentProfiles',N'') 
,--p_duplicate
 (N'',N'',N'',N'Hybris System Attributes',N'Hybris.dbo.Paymentinfos',N'typepkstring',N'bigint',N'AccountNumber',N'pk from composedtypes Where iternalCode=CreditCardPaymentInfo', N'default',N'AccountPaymentProfiles',N'') 
,--typepkstring
 (N'',N'',N'',N'Hybris System Attributes',N'Hybris.dbo.Paymentinfos',N'OwnerPkString',N'bigint',N'AccountNumber',N'Null for Accountlevel paymentinfos', N'default',N'AccountPaymentProfiles',N'') 
,--OwnerPkString
...
/* Pending Concerns From Thiru
 ...
 (N'',N'',N'',N'Hybris System Attributes',N'Hybris.dbo.Paymentinfos',N'createdTS',N'datetime',N'AccountNumber',N'Getdate for AccountLevel addresses', N'default',N'AccountAddresses',N'') 
,--createdTS	datetime
--modifiedTS	datetime
