...
public class MigratedRCTest extends RFBrandRefreshWebsiteBaseTest{
	
	
	private StoreFrontBrandRefreshHomePage storeFrontBrandRefreshHomePage;
	
	@Test
	public void testAddShippingBillingWhileAdhocCheckoutForRC(){
		...
		storeFrontBrandRefreshHomePage.loginAsPCUser("rc3_stg2_us_03@mailinator.com", password);
