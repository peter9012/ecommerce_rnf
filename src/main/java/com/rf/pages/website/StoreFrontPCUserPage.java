...
public class StoreFrontPCUserPage extends RFWebsiteBasePage{
	...
	public StoreFrontCartAutoShipPage addProductToPCPerk(){
		driver.waitForElementPresent(By.xpath("//div[@id='main-content']/div[@class='quick-product-wrapper'][1]/div[3]//input[@value='Add to PC Perks']"));
		driver.click(By.xpath("//div[@id='main-content']/div[@class='quick-product-wrapper'][1]/div[3]//input[@value='Add to PC Perks']"));
