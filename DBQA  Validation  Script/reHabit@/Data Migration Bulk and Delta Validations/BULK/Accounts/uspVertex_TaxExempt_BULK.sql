...
CREATE PROCEDURE [dbqa].[uspVertex_TaxExempt_BULK]
AS
    BEGIN
...
TO Load Mapping Column directly With SQL Stmt: 
...
(N' DM_QA.dbo.VertexAccounts' ,N'AccountNumber',N'nvarchar(255)' ,N'Excel Sheet from Business' ,N'Hybris.dbo.users' ,N'p_accountnumber' ,N'int' ,N'p_accountnumber' ,N'' , N'Key' ,N'Vertex_TaxExempt',N'') 
-- p_accountnumber 
,(N' DM_QA.dbo.VertexAccounts' ,N'Name',N'nvarchar(255)' ,N'Excel Sheet from Business' ,N'Hybris.dbo.users' ,N'p_name' ,N'int' ,N'p_accountnumber' ,N'' , N'c2c' ,N'Vertex_TaxExempt',N'SELECT  b.TargetKey ,
        Name ,
        p_name
FROM    #Source a
        JOIN #Target b ON a.SourceKey = b.TargetKey
WHERE   a.Name <> b.p_name') 
-- p_name 
...
--+++++++++++++++++++++++++++++++++++++++++
        ...
        DECLARE @SourceCount INT ,
            ...
            @owner NVARCHAR(50)= 'Vertex_TaxExempt' ,
        ...
        SELECT  AccountNumber [SourceKey] ,
                CONCAT(FirstName, SPACE(1), LastName) AS Name ,
                StartDate ,
                EndDate
        INTO    #Source
        FROM    DM_QA.dbo.VertexAccounts 
        ...
        SELECT  p_accountnumber AS TargetKey ,
                p_name
        INTO    #Target
